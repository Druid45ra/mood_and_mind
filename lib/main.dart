  ...
  Future<void> loadSettings() async {
    try {
      ...
      if (settings.isNotEmpty) {
        ...
        notifyListeners(); // Notifică widget-urile despre schimbare
      }
    } catch (e) {
    ...
    return Consumer<SettingsModel>(
      builder: (context, settings, child) {
        ...
        return MaterialApp(
          ...
          home: HomeScreen(
              database:
                  Provider.of<SettingsModel>(context, listen: false)._database),
        );
      },
    );
  }
                  ...
                  content: Column(
                    ...
                    children: [
                      ListTile(
                        ...
                        onTap: () {
                          settings.updateLanguage('ro'); // Actualizează limba
                          Navigator.pop(context);
                        },
                      ),
                      ListTile(
                        ...
                        onTap: () {
                          settings.updateLanguage('en'); // Actualizează limba
                          Navigator.pop(context);
                        },
                      ),
                    ],
